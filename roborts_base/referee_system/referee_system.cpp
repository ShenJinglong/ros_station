...
RefereeSystem::RefereeSystem(std::shared_ptr<roborts_sdk::Handle> handle): handle_(handle) {
    SDK_Init();
    ROS_Init();
}

void RefereeSystem::SDK_Init() {
    handle_->CreateSubscriber<roborts_sdk::cmd_game_state>(REFEREE_GAME_CMD_SET, CMD_GAME_STATUS, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                            std::bind(&RefereeSystem::GameStateCallback, this, std::placeholders::_1));
    handle_->CreateSubscriber<roborts_sdk::cmd_game_result>(REFEREE_GAME_CMD_SET, CMD_GAME_RESULT, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                            std::bind(&RefereeSystem::GameResultCallback, this, std::placeholders::_1));
    handle_->CreateSubscriber<roborts_sdk::cmd_game_robot_survivors>(REFEREE_GAME_CMD_SET, CMD_GAME_SURVIVAL, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                                    std::bind(&RefereeSystem::GameSurvivorCallback, this, std::placeholders::_1));


    handle_->CreateSubscriber<roborts_sdk::cmd_event_data>(REFEREE_BATTLEFIELD_CMD_SET, CMD_BATTLEFIELD_EVENT, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                            std::bind(&RefereeSystem::GameEventCallback, this, std::placeholders::_1));
    handle_->CreateSubscriber<roborts_sdk::cmd_supply_projectile_action>(REFEREE_BATTLEFIELD_CMD_SET, CMD_SUPPLIER_ACTION, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                                        std::bind(&RefereeSystem::SupplierStatusCallback, this, std::placeholders::_1));


    handle_->CreateSubscriber<roborts_sdk::cmd_game_robot_state>(REFEREE_ROBOT_CMD_SET, CMD_ROBOT_STATUS, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                                std::bind(&RefereeSystem::RobotStatusCallback, this, std::placeholders::_1));
    handle_->CreateSubscriber<roborts_sdk::cmd_power_heat_data>(REFEREE_ROBOT_CMD_SET, CMD_ROBOT_POWER_HEAT, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                                std::bind(&RefereeSystem::RobotHeatCallback, this, std::placeholders::_1));
    handle_->CreateSubscriber<roborts_sdk::cmd_buff_musk>(REFEREE_ROBOT_CMD_SET, CMD_ROBOT_BUFF, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                            std::bind(&RefereeSystem::RobotBonusCallback, this, std::placeholders::_1));
    handle_->CreateSubscriber<roborts_sdk::cmd_robot_hurt>(REFEREE_ROBOT_CMD_SET, CMD_ROBOT_HURT, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
                                                            std::bind(&RefereeSystem::RobotDamageCallback, this, std::placeholders::_1));
    handle_->CreateSubscriber<roborts_sdk::cmd_shoot_data>(REFEREE_ROBOT_CMD_SET, CMD_ROBOT_SHOOT, CHASSIS_ADDRESS, MANIFOLD2_ADDRESS,
...
void RefereeSystem::GameStateCallback(const std::shared_ptr<roborts_sdk::cmd_game_state> raw_game_status) {
    roborts_msgs::GameStatus game_status;//ros publisher
    ros_game_status_pub_ = ros_nh_.advertise<roborts_msgs::GameStatus>("game_status", 30);
    ros_game_result_pub_ = ros_nh_.advertise<roborts_msgs::GameResult>("game_result", 30);
    ros_game_survival_pub_ = ros_nh_.advertise<roborts_msgs::GameSurvivor>("game_survivor", 30);
